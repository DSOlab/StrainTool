...
# ./gmtstrainplot.sh -jpg -str strain.out -o output_str
# echo "[PLOTALL] ...plot rotational rates..."
# ./gmtstrainplot.sh -jpg -rot strain.out -o output_rot
# echo "[PLOTALL] ...plot dextral, sinistral maximum shear strain rates..."
# ./gmtstrainplot.sh -jpg -gtotaxes strain.out -o output_gtotaxes
# echo "[PLOTALL] ...plot maximum shear strain..."
# ./gmtstrainplot.sh -jpg -gtot strain.out -o output_gtot
# echo "[PLOTALL] ...plot dilatation..."
# ./gmtstrainplot.sh -jpg -dil strain.out -o output_dil
