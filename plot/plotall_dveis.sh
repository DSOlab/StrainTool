...
./gmtstrainplot.sh -jpg -vhor station_info.dat -psta -deltr -o ${prefix}output_vel${suffix}
echo  "[PLOTALL] ...plot principal axes of strain rates..."
./gmtstrainplot.sh -jpg -str strain_info.dat -psta -deltr -o ${prefix}output_str${suffix}
echo "[PLOTALL] ...plot rotational rates..."
./gmtstrainplot.sh -jpg -rot strain_info.dat -psta -deltr -o ${prefix}output_rot${suffix}
echo "[PLOTALL] ...plot dextral, sinistral maximum shear strain rates..."
./gmtstrainplot.sh -jpg -gtotaxes strain_info.dat -psta -deltr -o ${prefix}output_gtotaxes${suffix}
echo "[PLOTALL] ...plot maximum shear strain..."
./gmtstrainplot.sh -jpg -gtot strain_info.dat -psta -deltr -o ${prefix}output_gtot${suffix}
echo "[PLOTALL] ...plot dilatation..."
./gmtstrainplot.sh -jpg -dil strain_info.dat -psta -deltr -o ${prefix}output_dil${suffix}
echo "[PLOTALL] ...plot second invariant..."
./gmtstrainplot.sh -jpg -secinv strain_info.dat -psta -deltr -o ${prefix}output_2inv${suffix}
